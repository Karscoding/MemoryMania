...
De frontend staat in de folder /frontend. Als je inlogd als naam: Henk, ww: henk. Zal een admin knop verschijnen op de pagina waarme je gedirect kan worden
naar de Angular app. Dit kan ook zonder deze knop door naar de port van de angular app te gaan.
De frontend moet op port :8080 en de backend op :8000 zoals de readme hieronder verteld.

- Kars Hekman en Lucas Bruins
